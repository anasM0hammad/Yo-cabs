...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="home1.php"><i class="fas fa-home"></i><strong> HOME </strong></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="frofile.php"><i class="fas fa-user"></i><strong> PROFILE</strong></a>
      </li>

       <li class="nav-item  active">
        <a class="nav-link" href="booking.php"><i class="fas fa-car"></i><strong> BOOK CAB <span class="sr-only">(current)</span></strong></a>
      </li>
